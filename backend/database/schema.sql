...
(8, 'London Coding for Kids', 'Teach basic coding to children.', 'Guiding Scratch exercises.', 'Basic coding knowledge.', 'Shift from 1pm to 4pm.', 'Improved digital literacy.', '2025-12-12', '13:00:00', '16:00:00', '03:00:00', 'London', 'E7 8AB', 'Tech Hub', 15),
(8, 'Leeds Robotics Workshop', 'Guide students in building robots.', 'Explaining steps, troubleshooting.', 'STEM knowledge helpful.', 'Shift from 10am to 1pm.', 'Hands-on STEM learning.', '2025-12-15', '10:00:00', '13:00:00', '03:00:00', 'Leeds', 'LS7 5AA', 'Innovation Lab', 15),
...
(9, 'London Blood Drive', 'Assist in organizing a blood donation event.', 'Registering donors, refreshments.', 'Friendly volunteers.', 'Shift from 9am to 1pm.', 'Increased blood supply.', '2025-12-13', '09:00:00', '13:00:00', '04:00:00', 'London', 'E8 9AB', 'City Hall', 25),
(9, 'Leeds Blood Donation Day', 'Help with donor registration.', 'Guiding donors, serving snacks.', 'Organized volunteers.', 'Shift from 10am to 2pm.', 'Life-saving donations.', '2025-12-16', '10:00:00', '14:00:00', '04:00:00', 'Leeds', 'LS8 6AA', 'Community Centre', 20),
(9, 'Livingston Blood Drive', 'Support local blood donation event.', 'Assisting staff, donor care.', 'Friendly and calm demeanor.', 'Event runs from 11am to 3pm.', 'Improved healthcare support.', '2025-12-20', '11:00:00', '15:00:00', '04:00:00', 'Livingston', 'EH54 1AA', 'Town Hall', 20),
...
(10, 'Manchester Disaster Relief Kit Assembly', 'Assemble emergency kits for disaster victims.', 'Packing supplies, labeling boxes.', 'Able to lift boxes.', 'Shift from 10am to 1pm.', 'Faster disaster response.', '2025-12-31', '10:00:00', '13:00:00', '03:00:00', 'Manchester', 'M3 4AB', 'Relief Centre', 30),
(10, 'Livingston Relief Supplies Distribution', 'Distribute essential supplies to affected families.', 'Loading trucks, handing out kits.', 'Organized volunteers.', 'Event runs from 9am to 1pm.', 'Timely aid delivery.', '2025-12-21', '09:00:00', '13:00:00', '04:00:00', 'Livingston', 'EH54 0AA', 'Community Relief Centre', 25);
